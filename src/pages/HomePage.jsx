...
//                 <button className="bg-sky-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-sky-600 transition-colors flex items-center justify-center space-x-2">
//                   <span>Shop Now</span>
...
//           </p>
//           <button className="bg-white text-sky-500 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
//             Start Shopping Now
//           </button>
//         </div>
//       </section>
...
//                 <li><a href="#" className="hover:text-white transition-colors">Mass Gainers</a></li>
//                 <li><a href="#" className="hover:text-white transition-colors">Whey Protein</a></li>
...
//         axios.get(`${URL}/api/products/featured?limit=6`)
//       ]);
...
//     try {
//       const response = await axios.get(`${URL}/api/products?search=${encodeURIComponent(searchQuery)}&limit=20`);
//       console.log('Search results:', response.data.products);
//       alert(`Found ${response.data.products.length} products for "${searchQuery}"`);
//     } catch (err) {
